...
describe('event date helpers', () => {
  it('parses a local datetime and offset into a stable UTC instant', () => {
    expect(parseDateTimeLocalToUtc('2026-05-12T19:30', 180).toISOString()).toBe('2026-05-12T22:30:00.000Z')
  })

  it('formats event dates with the stored offset instead of the server timezone', () => {
    const formattedDate = formatEventDate(new Date('2026-05-12T22:30:00.000Z'), 180)

    expect(formattedDate).toContain('May 12, 2026')
