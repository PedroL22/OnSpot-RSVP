...
export const EventListItem = ({
  ...
  return (
    <Card
      className='animate-[fade-up_0.5s_var(--ease-out-expo)_both] overflow-hidden border-border/80 bg-card/95 py-0 shadow-[var(--shadow-sm)]'
    ...
    >
      ...
      <CardContent className='p-5'>
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6'>
          ...
          <div className='grid shrink-0 grid-cols-2 gap-3 sm:w-48 lg:w-56 lg:grid-cols-3'>
